...
namespace ActiveRagdoll
{
    ...
    {
        [Header("--- GENERAL ---")] [Tooltip("Where the camera should point to. Head by default.")]
        ...
        {
            _cameraRotation.x = Mathf.Repeat(_cameraRotation.x + _inputDelta.x * (invertX ? -1 : 1) * lookSensitivity,
                360);
